...
- **M2 进行中** custom 弹窗裁剪 + saved texts 升级书架 → 详见 `docs/plans/M2.md`。**a 弹窗裁剪 ✅(2026-07-31)/ b 本地书籍数据层 + 书架页 ✅(2026-07-31)/ c 书架操作闭环 + 虚线上传卡 + 本地多格式文本提取 ✅(2026-08-01)/ d 书籍模式与 Random 拆分 + 回合胶囊条 + 左右箭头 ✅(2026-08-01)**
